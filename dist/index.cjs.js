...
function createGridComponent(_ref2) {
  ...
  function (_PureComponent) {
    ...
    _proto.render = function render() {
      ...
      if (freezeRowCount) {
        for (var _rowIndex2 = 0; _rowIndex2 < freezeRowCount; _rowIndex2++) {
          for (var _columnIndex2 = Math.max(freezeColumnCount, columnStartIndex); _columnIndex2 <= columnStopIndex; _columnIndex2++) {
            freezeTopRightItems.push(react.createElement(children, {
              ...
              rowIndex: _rowIndex2,
              style: this._getItemStyle(_rowIndex2, _columnIndex2)
            }));
          }
        }
      ...
      if (freezeColumnCount) {
        var topLeftStyle = this._getItemStyle(freezeRowCount, freezeColumnCount);
        ...
        for (var _rowIndex3 = Math.max(freezeRowCount, rowStartIndex); _rowIndex3 <= rowStopIndex; _rowIndex3++) {
          for (var _columnIndex3 = 0; _columnIndex3 < freezeColumnCount; _columnIndex3++) {
            ...
            freezeBottomLeftItems.push(react.createElement(children, {
      ...
      if (freezeColumnCount && freezeRowCount) {
        for (var _rowIndex4 = 0; _rowIndex4 < freezeRowCount; _rowIndex4++) {
          for (var _columnIndex4 = 0; _columnIndex4 < freezeColumnCount; _columnIndex4++) {
            freezeTopLeftItems.push(react.createElement(children, {
              ...
              rowIndex: _rowIndex4,
              style: this._getItemStyle(_rowIndex4, _columnIndex4)
            }));
          }
        }
      ...
      if (freezeBottomLeftItems.length) {
        ...
        items.unshift(react.createElement('div', {
          ...
          style: {
            height: estimatedTotalHeight - _topLeftStyle.top,
      ...
      var outerElement = react.createElement(outerElementType || outerTagName || 'div', {
        className: className,
